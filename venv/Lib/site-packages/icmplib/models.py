...
class Host:
    ...
    :type src_addr: str
    :param src_addr: The IP address of the gateway
    ...
    def __init__(self, address, min_rtt, avg_rtt, max_rtt,
            transmitted_packets, received_packets, ttl, src_addr=None):
    ...
    def src_addr(self):
        '''
        Return the src_addr if the host is reachable, None otherwise.
        '''
